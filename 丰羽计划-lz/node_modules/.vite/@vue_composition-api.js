...
function updateVmAttrs(vm, ctx) {
  ...
  var _loop_1 = function(attr2) {
    if (!hasOwn(attrBindings, attr2)) {
      proxy(attrBindings, attr2, {
        get: function() {
...
// dep:@vue_composition-api
var vue_composition_api_default2 = vue_composition_api_default;
export {
  EffectScope,
  computed,
  createApp,
  createRef,
  customRef,
  vue_composition_api_default2 as default,
